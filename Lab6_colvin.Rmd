...
# As seen, there is a sharp increase of deaths in the US. now lets look at Canada 
...
state_join <- left_join(Canada, daily_report, by = c("region" = "Province_State"))
ggplot(data = Canada, mapping = aes(x = long, y = lat, group = group)) + 
  ...
  scale_fill_gradientn(colours = 
                         wes_palette("Zissou1", 100, type = "continuous"),
                         trans = "log10") +
  labs(title = "COVID-19 Confirmed Deaths in the Canada 3/26")
```
...
ggplot(data = Canada, mapping = aes(x = long, y = lat, group = group)) + 
  ...
  scale_fill_gradientn(colours = 
                         wes_palette("Zissou1", 100, type = "continuous"),
                         trans = "log10") +
  labs(title = "COVID-19 Confirmed Deaths in the Canada 9/26")
```

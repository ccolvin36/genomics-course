...
```
```{r}
ggplot(data = countryA, mapping = aes(x = Deaths, y = Country_Region)) + geom_bar(stat = 'identity') 
```
```{r}
ggplot(data = countryB, mapping = aes(x = Deaths, y = Country_Region)) + geom_bar(stat = 'identity') 
```
